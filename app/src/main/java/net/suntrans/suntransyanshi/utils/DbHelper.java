...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sql = " create table  switchs_tb ( CID INTEGER primary key autoincrement,"  //通道ID 唯一标示通道 ，自增长
                ...
                + "SwitchName TEXT,"
                + "Floor TEXT,"
                + "zhilianip TEXT,zhilianport TEXT,bendiip TEXT,bendiport TEXT,waiwangip TEXT,waiwangport TEXT)";
        db.execSQL(sql);     //创建开关表

        String sqls = " create table  alert_tb ( NID INTEGER primary key autoincrement,"  //用户名ID 唯一标示通道 ，自增长
                + "Name TEXT,"   //第六感名称
                + "RSAddr TEXT,"     //第六感地址
                + "Content TEXT,"   //报警内容
                + "Time TEXT);";  //报警时间
